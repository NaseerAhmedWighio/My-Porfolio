    ...
    return (
        <main>
            <div className="flex items-center justify-center w-full min-h-screen" style={{ backgroundImage: `url(${bg3.src})`, backgroundSize: 'cover' }}>
                <div className="flex flex-col items-center justify-center space-y-6 h-auto w-full max-w-md p-6 bg-slate-300 rounded-xl shadow-lg">
                    <h1 className="text-2xl font-extrabold text-gray-700 text-center">Log In Your Account</h1>
