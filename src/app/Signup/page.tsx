    ...
    return (
        <main>
            <div className="flex items-center justify-center w-full h-screen" style={{ backgroundImage: `url(${bg3.src})`, backgroundSize: 'cover' }}>
                <div className="flex list-items justify-center -space-x-[450px] gap-y-9 h-[600px] w-[550px] absolute scale-75 md:scale-95 lg:scale-100">
                    ...
                    <Link href="../Login/" className="flex items-end justify-center"><button className=" bg-blue-700 py-4 w-[450px] rounded-xl text-2xl font-bold hover:bg-white hover:text-blue-700 absolute left-[50px] top-[560px]">Log In</button></Link>
                </div>
            </div>
        </main>
    )
